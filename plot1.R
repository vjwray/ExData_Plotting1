...
# Output   : plot1.png - in your current working directory the file plot1.png is created
...
hist(hpcdf$Global_active_power, main = "Global Active Power", xlab = "Global Active Power (kilowatts)", col = "red")
dev.off() 